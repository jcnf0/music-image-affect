...
#Default lr=2.0e-4
    ...
    def build_encoder(self):
        ...
        x = BasicConvLayer(filters=32, kernel_size=3, strides=(2, 2))(x)
        x = BasicConvLayer(filters=64, kernel_size=3, strides=(2, 2))(x)
        x = BasicConvLayer(filters=128, kernel_size=3, strides=(2, 2))(x)
        x = BasicConvLayer(filters=256, kernel_size=3, strides=(2, 2))(x)
        x = BasicConvLayer(filters=512,kernel_size=3, strides=(2, 2))(x)
        x = Flatten()(x)
        x = Dense(2048)(x)
        x = Activation('relu')(x)
    ...
    def build_decoder(self):
        ...
        x = BasicDeconvLayer(filters=512, kernel_size=3, strides=(2, 2))(x)
        x = BasicDeconvLayer(filters=256, kernel_size=3, strides=(2, 2))(x)
        x = BasicDeconvLayer(filters=128, kernel_size=3, strides=(2, 2))(x)
        x = BasicDeconvLayer(filters=64, kernel_size=3, strides=(2, 2))(x)
        x = BasicDeconvLayer(filters=32, kernel_size=3, strides=(2, 2))(x)
#         x = BasicDeconvLayer(filters=3, kernel_size=3, strides=(1, 1), bnorm=False, activation='tanh')(x)
        x = BasicDeconvLayer(filters=3, kernel_size=3, strides=(1, 1), bnorm=False, activation='sigmoid')(x)
